...
books ={
    "boo1" : {"title": "Lord of the rings", "Author": "Petros Kamara", "gener": "Fiction", "Total_copies": []},
    "boo2" : {"title": "J.O.D.Alie", "Author": "Kesuma Kamara", "gener": "Education", "Total_copies": []},
    "boo3" : {"title": "Way to Become rich", "Author": "Dwight .A. Doherty", "gener": "Non-fiction", "Total_copies": []},
}

Members = [
    {"member_id": "S001", "name": "Joel", "email": "joel@example.com", "borrowed_books": []},
    {"member_id": "S002", "name": "Louisa", "email": "louisa@example.com", "borrowed_books": []},
    {"member_id": "S003", "name": "Amisha", "email": "amisha@example.com", "borrowed_books": []},
    {"member_id": "ST001", "name": "Dwight", "email": "dwight@library.com", "borrowed_books": []},
    {"member_id": "ST002", "name": "Kesuma", "email": "Kesuma@library.com", "borrowed_books": []},
]
...
users = {
    # admins
    "Kesuma": {"password": "K006", "role": "admin"},
    "Caroline": {"password": "C007", "role": "admin"},
    # staff (linked to member IDs)
    "Joel": {"password": "J008", "role": "staff", "member_id": "ST001"},
    "Dwight": {"password": "D006", "role": "staff", "member_id": "ST002"},
    # students (linked)
    "Amisha": {"password": "A008", "role": "student", "member_id": "S001"},
    "Louisa": {"password": "L005", "role": "student", "member_id": "S002"},
    "Sajor": {"password": "S004", "role": "student", "member_id": "S003"},
}
